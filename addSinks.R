#This code identifies the metabolites which are most perturbed and adds sinks to them 

#The output is messed up. Dont know what is wrong. 
#Run this code and then run the code correct_addSinks.R which will give the correct output using the messed up output from this file
...
for(seed in seeds){
  ...
  list3=add_sinks(metabolites, reactions, SpeciesConst, sinkOf=changing_metabolites,g=g)
  ...
  colnames<-c('case', 'i', as.character(1:ncol(metabolites)))
